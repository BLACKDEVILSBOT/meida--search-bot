...
async def group(client, message):
    ...
    if 2 < len(message.text) < 50:    
        ...
        if len(btn) > 10: 
            ...
            buttons.append(
                    [
                            InlineKeyboardButton(text="🎃 ᴘᴀɢᴇ ɴᴜᴍʙᴇʀs 🎃"),
        ...
        buttons.append(
                    [
                            InlineKeyboardButton(text="🎃 ᴘᴀɢᴇ ɴᴜᴍʙᴇʀs 🎃"),
                            InlineKeyboardButton(text="《 1-{data['total']} 》",callback_data="pages")
                    ]   
                )
        poster=None
        if API_KEY:
        ...
        if query.data.startswith("next"):
            ...
            if int(index) == int(data["total"]) - 2:
                ...
                buttons.append(
                    [
                            InlineKeyboardButton(text="🎃 ᴘᴀɢᴇ ɴᴜᴍʙᴇʀs 🎃"),
                            InlineKeyboardButton(text="《 {int(index)+2}-{data['total']} 》", callback_data="pages")
                    ]   
                )
            ...
            if int(index) == 1:
                ...
                buttons.append(
                    [
                            InlineKeyboardButton(text="🎃 ᴘᴀɢᴇ ɴᴜᴍʙᴇʀs 🎃"),
                            InlineKeyboardButton(text="《 {int(index)}-{data['total']} 》", callback_data="pages")
                    ]   
                )
